...
const App = () => (
  <TooltipProvider>
    ...
    <Routes>
      ...
      <Route element={<AuthGuard roles={[ROLES.TECNICO]} />}>
        <Route
          path={ROUTES.TEMPORARY_FALLBACK.TECNICO}
          element={<TemporaryFallback />}
        />
      </Route>
      <Route element={<AuthGuard roles={[ROLES.CLIENTE]} />}>
        <Route
          path={ROUTES.TEMPORARY_FALLBACK.CLIENTE}
          element={<TemporaryFallback />}
        />
      </Route>
      ...
      <Route element={<AuthGuard roles={[ROLES.ADMINISTRATIVO]} />}>
        ...
        <Route
          path={ROUTES.ADMIN.CLIENT.DETAILS}
        ...
        />
        <Route
          path={ROUTES.ADMIN.SERVICE_ORDER.DETAILS}
