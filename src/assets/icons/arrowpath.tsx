...
export const ArrowPathIcon = ({ className, title = "Caminho de seta" }: IconProps) => {
  return (
    <svg
      className={className}
      width="24"
