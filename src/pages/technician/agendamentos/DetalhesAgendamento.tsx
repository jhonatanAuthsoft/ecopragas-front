      ...
      try {
        ...
        if (response.data.success) {
          ...
          const mappedAgendamento = {
            ...
            date: data.dataHoraAgendamento
              ? format(new Date(data.dataHoraAgendamento), "dd/MM/yyyy")
              : "",
            time: data.dataHoraAgendamento ? format(new Date(data.dataHoraAgendamento), "HH:mm") : "",
