...
import { buttonVariants } from "@/atomic/atm.button/button.component";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-brand-primary-medium text-white hover:bg-brand-primary-dark focus:bg-brand-primary-medium focus:text-white",
        day_today: "bg-brand-secondary-light/20 text-brand-secondary-dark",
        day_outside:
